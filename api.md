...
- <code title="post /pet/{petId}/uploadImage">client.pets.<a href="./src/test_project_anika_b/resources/pets.py">upload_image</a>(pet_id, \*\*<a href="src/test_project_anika_b/types/pet_upload_image_params.py">params</a>) -> <a href="./src/test_project_anika_b/types/pet_upload_image_response.py">PetUploadImageResponse</a></code>
