...
class TestTestProjectAnikaB:
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        client = TestProjectAnikaB(base_url=base_url, api_key=api_key, _strict_response_validation=False)
...
class TestAsyncTestProjectAnikaB:
    ...
    def test_default_headers_option(self) -> None:
        ...
        client2 = AsyncTestProjectAnikaB(
            base_url=base_url,
            api_key=api_key,
            _strict_response_validation=True,
            default_headers={
    ...
    def test_base_url_trailing_slash(self, client: AsyncTestProjectAnikaB) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncTestProjectAnikaB) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncTestProjectAnikaB) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        client = AsyncTestProjectAnikaB(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    def test_get_platform(self) -> None:
        ...
        from test_project_anika_b._base_client import get_platform
